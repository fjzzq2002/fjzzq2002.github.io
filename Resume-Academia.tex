...
Conduct research around AI safety and interpretability to better understand, align and control AI systems. Advised by Aditi Raghunathan.
...
\textbf{Research Intern}, Transluce \daterange[San Francisco,~CA]{05/2026}{08/2026}\\
Conducted and published research on situation awareness with Cassidy Laidlaw and Jacob Steinhardt.
...
Worked on interpreting and understanding neural networks with Neil Thompson, Jacob Andreas, Max Tegmark, and Ziming Liu.
...
\item \textbf{Let's talk about reward hacking}. MIT AI alignment (MAIA), 2025.
\item \textbf{Can we fix reward hacking?} Carnegie Mellon AI Safety Initiative (CASI), 2026.
\item \textbf{How can we stop reward seekers?} Jane Street Research Symposium, 2026.
\end{outerlist}

%--------------------------------------------------------------------------
\section*{Selected Works}
\begin{outerlist}
\item \textbf{User Awareness in Frontier Models}. Ziqian Zhong, Aditi Raghunathan, Cassidy Laidlaw, Jacob Steinhardt. Transluce Blog, 2026.
\item \textbf{Hardening Agent Benchmarks with Adversarial Hacker-Fixer Loops}. Ziqian Zhong, Ivgeni Segal, Ivan Bercovich, Shashwat Saxena, Kexun Zhang, Aditi Raghunathan. Preprint, 2026.
\item \textbf{Hodoscope: Unsupervised Monitoring for AI Misbehaviors}. Ziqian Zhong, Shashwat Saxena, Aditi Raghunathan. Preprint, 2026.
\item \textbf{ImpossibleBench: Measuring LLMs' Propensity of Exploiting Test Cases}. Ziqian Zhong, Aditi Raghunathan, Nicholas Carlini. ICLR 2026.
\item \textbf{Pando: Do Interpretability Methods Work When Models Won't Explain Themselves?}. Ziqian Zhong, Aashiq Muhamed, Mona T. Diab, Virginia Smith, Aditi Raghunathan. COLM 2026.
\item \textbf{Watch the Weights: Unsupervised monitoring and control of fine-tuned LLMs}. Ziqian Zhong, Aditi Raghunathan. ICLR 2026.
\item \textbf{Base Models Look Human To AI Detectors}. Yixuan Even Xu, Ziqian Zhong, Aditi Raghunathan, Fei Fang, J. Zico Kolter. Preprint, 2026.
\item \textbf{Early Data Exposure Improves Robustness to Subsequent Fine-Tuning}. Lawrence Feng, Gaurav R. Ghosal, Jacob Mitchell Springer, Ziqian Zhong, Aditi Raghunathan. Preprint, 2026.
\item \textbf{Algorithmic Capabilities of Random Transformers}. Ziqian Zhong, Jacob Andreas. NeurIPS~2024.
\item \textbf{The Clock and the Pizza: Two Stories in Mechanistic Explanation of Neural Networks}. Ziqian Zhong*, Ziming Liu*, Max Tegmark, Jacob Andreas. NeurIPS~2023 (Oral).
...
\begin{outerlist}
\item \textbf{Is my problem new?} (\href{http://yuantiji.ac/}{Link}, 11/2023). Employ LLMs and vector embeddings to detect similarity among competitive programming problems. $\sim$40k monthly page views and adopted by major contest setters.
